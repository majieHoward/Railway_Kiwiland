...
/**
 * 
 * @ClassName:  CalculationJustRightRouteDistance   
 ...
 */
public class CalculationJustRightRouteDistance extends BaseCalculationRouteSite implements CalculationRailwayRoute {

	private static volatile CalculationJustRightRouteDistance instance = null;

	public static CalculationJustRightRouteDistance getInstance() {
		if (instance == null) {
			synchronized (CalculationJustRightRouteDistance.class) {
				if (instance == null) {
					instance = new CalculationJustRightRouteDistance();
				}
			}
		}
		return instance;
